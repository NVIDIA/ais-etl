...
from ais.tf import Dataset, default_record_parser
from ais.tf.ops import Select, Decode, Convert, Resize
...
ais = Dataset(BUCKET_NAME, PROXY_URL, [Decode("jpg"), Convert("jpg", tf.float32), Resize("jpg", (224, 224))], [Select("jpg"), Select("cls")])
