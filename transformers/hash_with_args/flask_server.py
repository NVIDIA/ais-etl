"""
HashWithArgs ETL transformer (Flask)

Flask-based ETL server that computes an XXHash64 digest of each request's payload,
...
class HashWithArgs(FlaskServer):
    """
