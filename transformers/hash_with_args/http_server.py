"""
HashWithArgs ETL transformer (HTTP Server)

HTTP-based ETL server that computes an XXHash64 digest of each request's payload,
...
class HashWithArgs(HTTPMultiThreadedServer):
    """
